      ...
      >
        <div>
          <div className="main-grid m-auto h-screen max-h-screen w-screen max-w-96 p-4 md:max-w-screen-lg">
            ...
            <div
              className="player relative h-full max-h-full w-full justify-between gap-3 border-2 border-white md:p-12"
              style={{
            ...
            >
              ...
              <div
                className="download-links flex flex-col items-center justify-center pt-8 text-sm"
                style={{
                  minHeight: 80,
                  margin: -10,
                  padding: 0,
