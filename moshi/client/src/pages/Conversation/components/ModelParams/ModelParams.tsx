...
import type { useModelParams } from "../../hooks/useModelParams";
          ...
          <tr>
            ...
            <td className="p-2">
              <input
                ...
                max="500"
                value={textTopk}
                onChange={e => setTextTopk(parseInt(e.target.value, 10))}
              />
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td className="p-2">
              <input
                ...
                max="500"
                value={audioTopk}
                onChange={e => setAudioTopk(parseInt(e.target.value, 10))}
              />
            </td>
          </tr>
          <tr>
            ...
            <tr>
              ...
              <td className="p-2">
                <input
                  ...
                  onChange={e => setImageResolution(parseFloat(e.target.value))}
                />
              </td>
            </tr>
          )}
